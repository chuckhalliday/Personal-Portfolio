...
const Timeline = () => {
  ...
  return (
    <Section id="about">
      ...
      <SectionText>
      I'm an experienced and enthusiastic salesperson, musician, and explorer. <br /> Though my main focus is on programming, <br /> I am also well versed in both project management and client relations!
      </SectionText>
