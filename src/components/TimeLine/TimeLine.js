...
const Timeline = () => {
  ...
  return (
    <Section id="about">
      ...
      <SectionText>
      I'm an experienced & enthusiastic salesperson, musician, and explorer. Though my main focus is on programming, I am also comfortable with project management and client relations!
      </SectionText>
