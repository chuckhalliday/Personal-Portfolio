...
const Timeline = () => {
  ...
  return (
    <Section id="about">
      ...
      <SectionText>
      I'm an experienced and enthusiastic salesperson, musician, and explorer. <br /> Though my main focus is on programming, <br /> I am also comfortable with project management and client relations!
      </SectionText>
