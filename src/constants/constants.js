export const projects = [
  ...
  },
  {
    ...
    description: "The most powerful three man supergroup to not even be sued... yet",
    image: '/images/TW.gif',
...
export const TimeLineData = [
  ...
  { year: 2012, text: 'Learned to sell and earned promotion to management at Kirby', },
  { year: 2014, text: 'Learned B2B sales at Fastenal', },
  { year: 2016, text: 'Moved to Portland, Oregon', },
  { year: 2018, text: 'Became Chevy Certified', },
  { year: 2018, text: 'Became Subaru Certified and achieved highest personal month - 18 vehicles sold', },
  { year: 2019, text: 'Took on current high-volume position as Service Advisor, averaging almost $1,000,000 annually in managed repair orders', },
