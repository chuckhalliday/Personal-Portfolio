export const projects = [
  ...
  {
    title: 'Auto Advisor',
    description: `"Personal assistant" IOS app designed to emulate the discovery and recommendation process of a service advisor`,
...
export const TimeLineData = [
  ...
  { year: 2019, text: 'Offered current role as an automotive ASM in a high-volume environment (upwards of 300 monthly clients)', },
